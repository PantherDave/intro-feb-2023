describe('Declaring Variables in TypeScript', () => {
  ...
  describe('custom types', () => {
    ...
    it('can use classes', () => {
      ...
      expect(thisClass.getInfo()).toEqual(
        'This course is Intro to Programming and is 10 days long'
      );
  ...
  describe('some literals', () => {
    it('string literals', () => {
      ...
      expect(`The name is ${name} and he is ${age} years old`).toEqual(
        'The name is Henry and he is 11 years old'
      );
    });
  });
});
